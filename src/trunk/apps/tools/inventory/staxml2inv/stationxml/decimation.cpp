...
Decimation::MetaObject::MetaObject(const Core::RTTI* rtti, const Core::MetaObject *base) : Core::MetaObject(rtti, base) {
	addProperty(objectProperty<FrequencyType>("InputSampleRate", "StationXML::FrequencyType", false, false, &Decimation::setInputSampleRate, &Decimation::inputSampleRate));
	...
	addProperty(objectProperty<FloatType>("Delay", "StationXML::FloatType", false, false, &Decimation::setDelay, &Decimation::delay));
	addProperty(objectProperty<FloatType>("Correction", "StationXML::FloatType", false, false, &Decimation::setCorrection, &Decimation::correction));
}


IMPLEMENT_RTTI(Decimation, "StationXML::Decimation", Core::BaseObject)
