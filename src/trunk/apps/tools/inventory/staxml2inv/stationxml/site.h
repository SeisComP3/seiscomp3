...
#ifndef __SEISCOMP_STATIONXML_SITE_H__
#define __SEISCOMP_STATIONXML_SITE_H__
...
/**
 * \brief These fields describe the location of the station using ge
 * \brief -political boundaries.
 */
