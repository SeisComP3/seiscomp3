...
ResponseListElement::MetaObject::MetaObject(const Core::RTTI* rtti, const Core::MetaObject *base) : Core::MetaObject(rtti, base) {
	addProperty(objectProperty<FrequencyType>("Frequency", "StationXML::FrequencyType", false, false, &ResponseListElement::setFrequency, &ResponseListElement::frequency));
	addProperty(objectProperty<FloatType>("Amplitude", "StationXML::FloatType", false, false, &ResponseListElement::setAmplitude, &ResponseListElement::amplitude));
	addProperty(objectProperty<AngleType>("Phase", "StationXML::AngleType", false, false, &ResponseListElement::setPhase, &ResponseListElement::phase));
}


IMPLEMENT_RTTI(ResponseListElement, "StationXML::ResponseListElement", Core::BaseObject)
