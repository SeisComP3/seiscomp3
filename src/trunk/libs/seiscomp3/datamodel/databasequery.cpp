...
DatabaseIterator DatabaseQuery::getEventPicks(const std::string& eventID) {
	...
	std::string query;
	query += "select distinct(PPick." + _T("publicID") + "),Pick.* from OriginReference,Origin,PublicObject as POrigin,Event,PublicObject as PEvent,Arrival,Pick,PublicObject as PPick where OriginReference." + _T("originID") + "=POrigin." + _T("publicID") + " and Arrival." + _T("pickID") + "=PPick." + _T("publicID") + " and Arrival._parent_oid=Origin._oid and OriginReference._parent_oid=Event._oid and Origin._oid=POrigin._oid and Event._oid=PEvent._oid and Pick._oid=PPick._oid and PEvent." + _T("publicID") + "='";
	query += toString(eventID);
	query += "'";
