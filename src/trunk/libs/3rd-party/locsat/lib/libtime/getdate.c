...
static const yytype_uint8 yyprhs[] =
{
      ...
      19,    21,    24,    28,    33,    39,    47,    54,    63,    65,
      67,    69,    72,    75,    79,    85,    88,    93,    96,   100,
...
static const yytype_int8 yyrhs[] =
{
      ...
      -1,    25,    -1,    24,    -1,    26,    -1,    21,    -1,     7,
      -1,     7,     6,    -1,     7,    14,     7,    -1,     7,    14,
       7,     6,    -1,     7,    14,     7,    14,     7,    -1,     7,
      14,     7,    14,     7,    15,     7,    -1,     7,    14,     7,
      14,     7,     6,    -1,     7,    14,     7,    14,     7,    15,
       7,     6,    -1,    11,    -1,    12,    -1,     5,    -1,     5,
      16,    -1,     7,     5,    -1,     7,    17,     7,    -1,     7,
      17,     7,    17,     7,    -1,     4,     7,    -1,     4,     7,
      16,     7,    -1,     7,     4,    -1,     7,     4,     7,    -1,
       7,     8,    -1,     7,     9,    -1,     7,    10,    -1,     8,
      -1,     9,    -1,    10,    -1,    26,    13,    -1
};
...
{
       0,    47,    47,    48,    50,    52,    54,    56,    58,    60,
      62,    66,    68,    70,    72,    74,    76,    78,    81,    83,
      86,    88,    90,    93,    95,    97,    99,   101,   103,   107,
...
static const char *const yytname[] =
{
  ...
  "'.'", "','", "'/'", "$accept", "timedate", "item", "nspec", "tspec",
  "zone", "dyspec", "dtspec", "rspec", 0
};
#endif
...
{
     -14,     7,   -14,     1,   -13,    -4,   -14,   -14,   -14,   -14,
     -14,   -14,   -14,   -14,   -14,   -14,   -14,     8,    -7,   -14,
      17,   -14,   -14,   -14,   -14,   -14,    18,    19,   -14,    20,
     -14,    16,     6,   -14,   -14,    21,    24,    14,   -14,   -14,
      25,    27,   -14
};
...
{
      20,    21,    22,    19,    23,    24,    25,     2,    18,    29,
      26,     3,     4,    27,     5,     6,     7,     8,     9,    10,
      39,    28,    34,    36,    30,    31,    32,    33,    37,    40,
      35,    38,    41,    42
};

static const yytype_uint8 yycheck[] =
{
       4,     5,     6,    16,     8,     9,    10,     0,     7,    16,
      14,     4,     5,    17,     7,     8,     9,    10,    11,    12,
       6,    13,     6,    17,     7,     7,     7,     7,     7,    15,
      14,     7,     7,     6
};
...
static const yytype_uint8 yystos[] =
{
      ...
      12,    20,    21,    22,    23,    24,    25,    26,     7,    16,
       4,     5,     6,     8,     9,    10,    14,    17,    13,    16,
       7,     7,     7,     7,     6,    14,    17,     7,     7,     6,
      15,     7,     6
};
...
#line 73 "getdate.y"
  ...
  case 15:
#line 75 "getdate.y"
    {hh = (yyvsp[(1) - (7)]); mm = (yyvsp[(3) - (7)]); ss = (yyvsp[(5) - (7)]); fs = (yyvsp[(7) - (7)]); merid = 24;}
    break;
...
#line 77 "getdate.y"
  ...
  case 17:
#line 79 "getdate.y"
    {hh = (yyvsp[(1) - (8)]); mm = (yyvsp[(3) - (8)]); ss = (yyvsp[(5) - (8)]); fs = (yyvsp[(7) - (8)]); merid = (yyvsp[(8) - (8)]);}
    break;
...
int mm, dd, yr, h, m, s, f, mer, zone, dayflag;
{
	...
	jdate *= daysec;
	jdate += zone * 60L;
	if (dayflag==DAYLIGHT || (dayflag==MAYBE&&localtime((const time_t *)&jdate)->tm_isdst))
		jdate += -1*60*60;
...
double dayconv(ord, day, now) int ord, day; double now;
{
	...
	tod = now;
	loctime = localtime((const time_t *)&tod);
...
double monthadd(sdate, relmonth) double sdate; time_t relmonth;
{
	...
	ltime = localtime((const time_t *)&sdate);
...
double daylcorr(future, now) double future, now;
{
	...
	nowdayl = (localtime((const time_t *)&now)->tm_hour+1) % 24;
	fdayl = (localtime((const time_t *)&future)->tm_hour+1) % 24;
...
#endif
	lt = localtime((const time_t *)&now->time);
	year = lt->tm_year;
	month = lt->tm_mon+1;
	day = lt->tm_mday;
	relsec = 0; relmonth = 0;
