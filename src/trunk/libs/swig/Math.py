...
class vectorf(_object):
    ...
    def __setslice__(self, *args):
        ...
        __setslice__(vectorf self, std::vector< float >::difference_type i, std::vector< float >::difference_type j, 
            vectorf v=std::vector< float,std::allocator< float > >())
        __setslice__(vectorf self, std::vector< float >::difference_type i, std::vector< float >::difference_type j)
        """
...
class HotspotListF(_object):
    ...
    def insert(self, *args):
        ...
        insert(HotspotListF self, std::vector< Seiscomp::Math::Geo::NamedCoord< float > >::iterator pos, std::vector< Seiscomp::Math::Geo::NamedCoord< float > >::size_type n, 
            NamedCoordF x)
        """
...
class HotspotListD(_object):
    ...
    def insert(self, *args):
        ...
        insert(HotspotListD self, std::vector< Seiscomp::Math::Geo::NamedCoord< double > >::iterator pos, std::vector< Seiscomp::Math::Geo::NamedCoord< double > >::size_type n, 
            NamedCoordD x)
        """
...
class CityF(NamedCoordF):
    ...
    def __init__(self, *args): 
        ...
        __init__(Seiscomp::Math::Geo::City<(float)> self, std::string const & name, std::string const & countryID, float lat_, float lon_, 
...
class CityD(NamedCoordD):
    ...
    def __init__(self, *args): 
        ...
        __init__(Seiscomp::Math::Geo::City<(double)> self, std::string const & name, std::string const & countryID, double lat_, double lon_, 
...
class CityListF(_object):
    ...
    def insert(self, *args):
        ...
        insert(CityListF self, std::vector< Seiscomp::Math::Geo::City< float > >::iterator pos, std::vector< Seiscomp::Math::Geo::City< float > >::size_type n, 
            CityF x)
        """
...
class CityListD(_object):
    ...
    def insert(self, *args):
        ...
        insert(CityListD self, std::vector< Seiscomp::Math::Geo::City< double > >::iterator pos, std::vector< Seiscomp::Math::Geo::City< double > >::size_type n, 
            CityD x)
        """
...
class WWSSN_SPF(_object):
    ...
    def __init__(self, *args): 
        """
        __init__(Seiscomp::Math::Filtering::IIR::WWSSN_SP_Filter<(float)> self, Seiscomp::Math::GroundMotion input=Velocity) -> WWSSN_SPF
...
class WWSSN_SPD(_object):
    ...
    def __init__(self, *args): 
        """
        __init__(Seiscomp::Math::Filtering::IIR::WWSSN_SP_Filter<(double)> self, Seiscomp::Math::GroundMotion input=Velocity) -> WWSSN_SPD
...
def scxsc(*args):
  """
    scxsc(double lat1, double lon1, double r1, double lat2, double lon2, double r2, double * latx1, 
        double * lonx1, double * latx2, double * lonx2, double epsilon=0) -> int
    scxsc(double lat1, double lon1, double r1, double lat2, double lon2, double r2, double * latx1, 
        double * lonx1, double * latx2, double * lonx2) -> int
    """
...
class TransferFunction(Core.BaseObject):
    ...
    def __div__(self, *args):
        """__div__(TransferFunction self, TransferFunction a) -> TransferFunction"""
...
class TransferFunctionPAZ(TransferFunction):
    ...
    def __init__(self, *args): 
        ...
        PolesAndZeros(int n_poles, Seiscomp::Math::Restitution::Pole * poles, int n_zeros, Seiscomp::Math::Restitution::Zero * zeros, 
            double k, int addZeros=0) -> TransferFunctionPAZ
        __init__(Seiscomp::Math::Restitution::FFT::PolesAndZeros self, int n_poles, Seiscomp::Math::Restitution::Pole * poles, int n_zeros, Seiscomp::Math::Restitution::Zero * zeros, 
            double k) -> TransferFunctionPAZ
        """
...
class vectorc(_object):
    ...
    def insert(self, *args):
        ...
        insert(vectorc self, std::vector< std::complex< double > >::iterator pos, std::vector< std::complex< double > >::size_type n, 
